...
const Register = () => {
  return (
    ...
    <div class="relative flex flex-col text-white bg-transparent shadow-none rounded-xl bg-clip-border">
      <h4 class="block font-sans text-2xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
        Sign Up
      </h4>
      <p class="block mt-1 font-sans text-base antialiased font-normal leading-relaxed text-white-700">
      ...
      <form class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
        ...
        <div class="inline-flex items-center">
          ...
          <label
            ...
            htmlFor="remember"
          >
            <p class="flex items-center font-sans text-sm antialiased font-normal leading-normal text-white-700">
              I agree the
              <a
                href="#"
                class="font-medium transition-colors hover:text-white-900"
              >
        ...
        <p class="block mt-4 font-sans text-base antialiased font-normal leading-relaxed text-center text-white-700">
